...
def Breakpoints(EPIC, cadence = 'lc', **kwargs):  
  ...
  if cadence == 'lc':
    ...
    breakpoints = {
                  0: np.array([  3753,  11259,  15012,  18765,  60048,            
                                 63801,  67554,  71307, 75060,  78815, 
                                 82566,  86319,  90072, 93825,  97578, 
                                 101331, 105084, 108837]),        
                  1: np.array([ 8044,   12066,  16088,  20135,  24132,  28154,    
                  ...
                  3: np.array([  3316,  6772,   10158,  13694,  16930,  20316,    
                  ...
                  5: np.array([  3663,   7326,  10989,  14652,  18315,  21978,    
