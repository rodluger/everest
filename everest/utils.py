...
# Constants
AP_COLLAPSED_PIXEL = 9 # Marks a pixel into which a row was collapsed, & 1 = 1
AP_SATURATED_PIXEL = 8 # Marks a saturated pixel that was masked out, & 1 = 0
...
def _float(s):
  '''
  Silly wrapper around float() that returns `np.nan` on error
