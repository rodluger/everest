...
def PrimaryHDU(model):
  ...
  # Get mission cards
  cards = HDUCards(model.meta, hdu = 0)
...
def LongCadenceHDU(model):
  ...
  # Get mission cards
  cards = HDUCards(model.meta, hdu = 1)
...
def ShortCadenceHDU(model):
  ...
  # Get mission cards
  cards = HDUCards(model.meta, hdu = 6)
...
def LongCadencePixelHDU(model):
  ...
  # Get mission cards
  cards = HDUCards(model.meta, hdu = 2)
...
def ApertureHDU(model):
  ...
  # Get mission cards
  cards = HDUCards(model.meta, hdu = 3)
...
def ImagesHDU(model):
  ...
  # Get mission cards
  cards = HDUCards(model.meta, hdu = 4)
...
def HiResHDU(model):
  ...
  # Get mission cards
  cards = HDUCards(model.meta, hdu = 5)
