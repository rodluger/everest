  ...
  \begin{center}
      \psfig{file=images/comparison_kepler.png,width=3.5in}
       \caption{6-hr photometric precision as a function of Kepler magnitude $K_p$
                ...
                in campaigns 0-6 de-trended with \texttt{EVEREST}
                (blue dots). The median values and the standard deviations are indicated
...
NNA13AA93A. This research used the advanced computational,
