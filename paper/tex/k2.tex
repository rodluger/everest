...
Andrew Becker\altaffilmark{1}, Daniel Foreman-Mackey\altaffilmark{1}, and Drake Deming\altaffilmark{3}}
...
%
% TODO: Provide the links in the published version
...
%publicly-available database\footnote{\texttt{\url{https://archive.stsci.edu/prepds/everest/}}}
...
package, which calculates fast limb-darkened light curves based on the \citep{MA02} transit model. 
  ...
  \begin{center}
      \psfig{file=images/comparison_kepler.png,width=3.5in}
       \caption{6-hr photometric precision as a function of Kepler magnitude $K_p$
                ...
                (blue dots). The median values and the robust standard deviations are indicated
...
\begin{figure}[h]
  \begin{center}
      \psfig{file=images/comparison_k2sff_by_campaign.png,width=3.5in}
...
%
% TODO: Provide links in the published version
...
R.L. and R.B. acknowledge support from the NASA Astrobiology
...
NNA13AA93A. E.A. acknowledges support from NASA grants NNX13AF20G, NNX13AF62G, and NASA
Astrobiology Institute's Virtual Planetary Laboratory, supported by NASA
