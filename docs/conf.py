# -*- coding: utf-8 -*-
#
# templar documentation build configuration file, created by
# sphinx-quickstart on Sun Aug 16 18:20:29 2015.
#
...
sys.path.insert(0, os.path.abspath('../kplr'))
...
latex_documents = [
  (master_doc, 'everest.tex', u'everest documentation',
   u'Rodrigo Luger', 'manual'),
]
